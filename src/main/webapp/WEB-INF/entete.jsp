        ...
        <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink0" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Tableau de bord</a>
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink0">
                        <li><a class="dropdown-item" href="dashboard">Voir mes informations</a></li>
                        <li><a class="dropdown-item" href="dashboard#invitationsEnvoyes">Voir mes invitations</a></li>
                        <li><a class="dropdown-item" href="personne?ID=${personne.id}">Modifier mes informations</a></li>
                    </ul>
                </li>
